...
# TODO glob pickles of meteoFiles
py_glob = os.path.join("/Users/dnd/Downloads/", "data_*_Wallonie_Brabant")
for filepath in glob.iglob(py_glob):
    with open(filepath, 'rb') as f:
        meteolist = pickle.load(f)
